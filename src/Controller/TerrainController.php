...
class TerrainController extends AbstractController
{
    ...
    #[Route('/{id}/commentaires', name: 'app_terrain_commentaires', methods: ['GET', 'POST'])]
    public function commentaires(Request $request, Terrain $terrain, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(TerrainType::class, $terrain);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_terrain_commentaires');
        }

        return $this->render('terrain/commentaires.html.twig', [
            'form' => $form->createView(),
             'terrain' => $terrain,
        ]);
    }
